...
# first table
sql = "INSERT INTO passengers (id, fname, lname, seatno, address, dob, status) VALUES (%s, %s, %s, %s, %s, %s, %s)"
val = [
...
sql = "INSERT INTO events (id, date, passengerID, geo_location, description, status, other_pass) VALUES (%s, %s, %s, %s, %s, %s, %s)"
val = [
    ...
    ('3', '2022-10-10', '5', '-15.344, 120.031', 'I see the 2 dogs but I feel there are much more', 'failure', '1')
       ]
